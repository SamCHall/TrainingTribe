  ...
  const renderCardio = (workout) => {
    for (let i = 0; i < workout.exercises.length; i++) {
      if (workout.exercises[i].type === "Cardio") {
        return <Text style={globalStyles.text}>Cardio: Yes</Text>;
      }
    }
    return <Text style={globalStyles.text}>Cardio: No</Text>;
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={globalStyles.text}>
            Sets: {workout.exercises.reduce((a, b) => a + b.sets.length, 0)}
          </Text>
        </View>
        <View
          style={{
        ...
        <View style={{ flex: 1 }}>
          <Text
            style={[globalStyles.text, { alignSelf: "center", marginTop: 5 }]}
          >
            Total Volume: {totalWorkoutVolume(workout)} kg
          </Text>
        </View>
        <OvalButton
          text="View Workout"
